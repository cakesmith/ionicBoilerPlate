...
(function (simpleLoginTools) {
  ...
  *    }
  ...
  simpleLoginTools.service('waitForAuth', ['$rootScope', '$q', '$timeout', function ($rootScope, $q, $timeout) {
    function fn(err) {
      if ($rootScope.auth) {
   ...
   * </code>
   */
  simpleLoginTools.config(['$provide', function ($provide) {
    // adapt ng-cloak to wait for auth before it does its magic
    $provide.decorator('ngCloakDirective', ['$delegate', 'waitForAuth',
      function ($delegate, waitForAuth) {
...
}(angular.module('Tectonic.module.simpleLoginTools', [])));