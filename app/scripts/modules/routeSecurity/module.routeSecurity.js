...
(function (routeSecurity) {
  ...
  routeSecurity.run(['$injector', '$location', '$rootScope', 'loginRedirectPath', function ($injector, $location, $rootScope, loginRedirectPath) {
...
}(angular.module('Tectonic.module.routeSecurity', [
